  ...
  return (
    <div className=" bg-black text-white py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-12">
          <p className="text-sm text-[#F9BC07] mb-2 tracking-wide">Our Reviews</p>
          <div className="flex items-center gap-2 mb-4">
            {[...Array(5)].map((_, i) => (
              <svg key={i} className="w-5 h-5 text-[#F9BC07]" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div className="md:col-span-3 grid md:grid-cols-3 gap-4 md:gap-6">
                      {testimonials.map((item, idx) => (
                        ...
                        >
                          <div>
                            <div className="border border-[#F9BC07] rounded-2xl p-6 sm:p-8 h-full flex flex-col relative bg-black hover:border-yellow-300 transition-colors mb-6">
                              {/* Quote Mark */}
