...
export default function CoreServices() {
  const services = [
    ...
    { number: '03', title: 'Unlimited Tea & Coffee' },
  ...
  const stats = [
    ...
    { number: '15+', label: ['ROOMS'] },
    { number: '50', label: ['OPEN SEATS'] },
    { number: '24h', label: ['SERVICE', 'AVAILABLE'] }
  ];
    ...
    <div className="min-h-screen bg-black text-white px-6 py-12 md:px-12 lg:px-20">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-16 md:mb-24">
          <div>
            <p className="text-yellow-400 text-sm md:text-base mb-4 font-medium">Core Services</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
              Our mission is to make<br />
              your work life smooth<br />
              and easy
            </h1>
          </div>
          <button className="mt-8 md:mt-0 border-2 border-dashed border-yellow-400 text-yellow-400 px-8 py-3 rounded-full hover:bg-yellow-400 hover:text-black transition-all duration-300 font-medium">
            VIEW ALL SERVICES
          </button>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 lg:gap-16">
          {services.map((service, index) => (
            <div 
              ...
              className={`flex items-center gap-6 md:gap-8 group transition-all duration-700 ${
            ...
            >
              <span 
                className="text-5xl md:text-6xl lg:text-7xl font-bold text-transparent transition-all duration-500" 
                style={{
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold group-hover:text-yellow-400 transition-colors duration-300">
                {service.title}
              </h2>
            </div>
          ))}
