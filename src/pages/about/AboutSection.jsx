     ...
     <div className="absolute inset-0 bg-gradient-to-br from-black/70 via-black/60 to-black/70"></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <div className="flex flex-wrap gap-6 md:gap-12 justify-center mb-20 md:mb-32">
          <button className="flex flex-col items-center gap-3 text-white hover:text-yellow-400 transition-colors group">
      ...
      <div className="absolute top-[85%] left-0 w-full h-24 overflow-hidden bg-yellow-500 transform -rotate-3 shadow-2xl z-10">
