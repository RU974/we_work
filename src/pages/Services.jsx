    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex mt-15 flex-col md:flex-row justify-between items-center gap-4">
          <div className="bg-yellow-400 text-black px-4 md:px-6 py-2 md:py-3 rounded-full font-bold text-xs md:text-sm text-center">
            THE PERFECT PLACE TO WORK AND COLLABORATE
          </div>
          <button className="border-2 border-yellow-400 text-yellow-400 px-4 md:px-6 py-2 rounded-full font-semibold hover:bg-yellow-400 hover:text-black transition-all duration-300 text-sm md:text-base">
            VIEW ALL SERVICES
          </button>
        </div>
      </header>
      ...
      <section className="container mx-auto px-4 py-8 md:py-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-16">
          ...
          <div className="relative group overflow-hidden rounded-2xl border-4 border-yellow-400 md:transform md:-translate-y-8">
